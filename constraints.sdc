...
create_generated_clock -name VCLK -source [get_pins -compatibility_mode {*|pll|pll_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -divide_by 7 -duty_cycle 57.1 [get_nets {emu|fpgagen|VCLK}]
create_generated_clock -name ZCLK -source [get_pins -compatibility_mode {*|pll|pll_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -divide_by 14 -duty_cycle 50 [get_nets {emu|fpgagen|ZCLK}]

create_generated_clock -name romrd_req -source [get_pins -compatibility_mode {*|pll|pll_inst|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -divide_by 7  [get_nets {*|romrd_req}] 
